        ...
        <div className="flex justify-between items-center">
            ...
            <section className="detail-page ">
                <div className="card-detail">
                    ...
                    <div className="mx-12"  data-aos="flip-down">
                    ...
                    <div className="flex justify-between mt-4">
                        <p  data-aos="flip-left" className="font-bold text-orange-500">Category:  <span className="bg-black font-normal text-white px-2 py-1 rounded-md">Health</span></p>
                    ...
                    <p   data-aos="flip-right" className="mt-8 text-justify">{singleBlog.description}</p>
                </div>
