        ...
        {/* <div className="flex  flex-row justify-around gap-12  bg-gray-200"> */}
            ...
            {/* <div className="left-section justify-center flex basis-4/5 gap-4 flex-wrap"> */}
                ...
                <div className="post-parent mt-3"  data-aos="flip-left">
                    ...
                    <Link to={`/post/${id}`} className="mt-2 text-normal sm:text-xl flex justify-center font-semibold hover:text-orange-500 leading-5 mb-4 cursor-pointer">{title}</Link>
