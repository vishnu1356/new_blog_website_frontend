const NewsLetter = () => {
    return (
        <div class="mx-auto max-w-7xl px-2 py-10 lg:px-0 mt-4">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between lg:space-x-10">
                <div class="mb-10 w-full md:w-2/3 lg:mb-0 lg:w-1/2">
                    <img
                ...
                <div class="w-full md:w-2/3 lg:w-1/2">
                    ...
                    <h2 class="mt-4 text-3xl font-bold text-black">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-4 flex items-center space-x-4">
                            <div class="isolate flex -space-x-2">
                                ...
                                />
                                <img
                                    class="relative z-10 inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white"
                    ...
                    <form class="mt-6">
                        <div class="flex w-full max-w-md flex-col space-y-4">
                            <input
                                class="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm focus:ring-orange-500 focus:border-orange-300 placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                                type="email"
                                placeholder="Email"
                            />
                            <button
                                type="button"
                                class="w-full rounded-md bg-orange-500 px-3 py-2 text-lg font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                            >
                                Subscribe
                            </button>
                        </div>
